...
@section('content')
	<div class="category-posts">
		<div class="category-index bg-category">
			<div class="category-name">
			    {{ $category->name }}
			</div>
		</div>
		@for ($num = (int)$posts->count(), $i = 0; $i < ceil($num/2); $i++)
			<div class="row">
						...
						<article class="post">
			                ...
			                <div style="display: block;">
			                    ...
			                    <div class="post-entry">
			                    	<p class="post-body">
	                        			{!! str_limit(strip_tags($posts[$j]->body), $limit = 300, $end = ' ...') !!}
	                        		</p>
			                    </div>
			                    <div class="post-entry">
			                        <p> 
